...
//		restClassSet.add(AuthorizationFilter.class);
		...
		restClassSet.add(InvalidAcctExResolver.class);// Exception Mappers that  you have  to register
		restClassSet.add(UnknownResourceExResolver.class);// Exception Mappers that you have to register
